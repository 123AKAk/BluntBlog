            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="ad-auth-content">
                        <form>
                            <a href="index.php" class="ad-auth-logo">
                            ...
                            <div class="ad-auth-btn">
                                <a href="javascript:void(0);" class="ad-btn ad-login-member">Send Password</a>
                            </div>
                            <p class="ad-register-text">Already have an account ? <a href="login.php">Login</a></p>
                        </form>
                    </div>
                </div>
            </div>
...
<!-- Mirrored from kamleshyadav.com/html/splashdash/HTML/bootstrep-5/splashdash-admin-template/forgot-pws.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 14 Jun 2022 14:47:56 GMT -->
</html>