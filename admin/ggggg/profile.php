                      ...
                      <div class="row">
                        <div class="col-md-5">
                          <div class="mb-3">
                            ...
                            <input class="form-control" type="text" placeholder="Company" data-bs-original-title="" title="">
                          </div>
                        </div>
                        <div class="col-sm-6 col-md-3">
                          <div class="mb-3">
                            <label class="form-label">Username</label>
                            <input class="form-control" type="text" placeholder="Username" data-bs-original-title="" title="">
                          </div>
                        </div>
                        <div class="col-sm-6 col-md-4">
                          <div class="mb-3">
                            <label class="form-label">Email address</label>
                            <input class="form-control" type="email" placeholder="Email" data-bs-original-title="" title="">
                          </div>
                        </div>
                        ...
                        <div class="col-md-12">
                          <div class="mb-3">
                            ...
                            <input class="form-control" type="text" placeholder="Home Address" data-bs-original-title="" title="">
                          </div>
                        </div>
                        <div class="col-sm-6 col-md-4">
                          <div class="mb-3">
                        ...
                        <div class="col-sm-6 col-md-3">
                          <div class="mb-3">
                            ...
                            <input class="form-control" type="number" placeholder="ZIP Code" data-bs-original-title="" title="">
                          </div>
                        </div>
                        <div class="col-md-5">
