...
$stmt = $conn->prepare("SELECT * FROM `article` INNER JOIN category ON id_categorie=category_id INNER JOIN postviews ON article_id=postid WHERE article_status=1 ORDER BY viewcount DESC LIMIT 4");
$stmt->execute();
    ...
    <div class="theiaStickySidebar">
        <div class="sidebar">
            ...
            <div class="widget widget-newsletter">
                ...
                <form class="newslettre-form" id="anewslettre-form">
                    <span id="amsgspan"></span>
                    <br>
                    <div class="form-flex mt-2">
                        <div class="form-group">
                            <input type="email" id="anewsletteremail" name="newsletteremail" class="form-control" placeholder="Your Email Adress" required="required">
                        </div>
